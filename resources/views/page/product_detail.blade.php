		...
		<div id="content">
			<div class="row">
				<div class="col-sm-9">
					...
					<div class="row">
						<div class="col-sm-4">
							<img src="template/image/product/{{$p_detail->image}}" alt="">
						</div>
						<div class="col-sm-8">
							<div class="single-item-body">
								<p class="single-item-title">{{$p_detail->name}}</p>
							...
							<div class="single-item-options">
								...
								<a class="add-to-cart" href="{{route('addcart',$p_detail->id)}}"><i class="fa fa-shopping-cart"></i></a>
								<div class="clearfix"></div>
							</div>
						</div>
					</div>
					...
					<div class="beta-products-list">
									...
									<div class="col-sm-4">
    									<div class="single-item">
    										...
    										<div class="single-item-header">
    											<a href="{{route('product-detail',$p->id)}}"><img src="template/image/product/{{$p->image}}" alt=""></a>
    										</div>
    										<div class="single-item-body">
    											...
    											<p class="single-item-price">
    												...
    												@else
    													<span>{{number_format($p->unit_price)}} đồng</span>
    												@endif
    											</p>
    										</div>
    										<div class="single-item-caption">
    											<a class="add-to-cart pull-left" href="{{route('addcart',$p->id)}}"><i class="fa fa-shopping-cart"></i></a>
    											<a class="beta-btn primary" href="{{route('product-detail',$p->id)}}">Details <i class="fa fa-chevron-right"></i></a>
    											<div class="clearfix"></div>
    										</div>
    									</div>
    								</div>
						...
						<div class="row">{{$p_same->links()}}</div>
