					...
					<div class="beta-comp">
						...
						<div class="cart">
							...
							@foreach($product_cart as $product)
								<div class="cart-item">
									<div class="media">
										<a class="pull-left" href="#"><img src="/template/image/product/{{$product['item']['image']}}" alt=""></a>
										
										<a class="pull-right cart-item-delete" href="{{route('delonecart',$product['item']['id'])}}">X</a>
